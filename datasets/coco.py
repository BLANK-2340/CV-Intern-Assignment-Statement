...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train/train_images", root / "train/train.json"),
        "train_reg": (root / "train/train_images", root / "train/train.json"),
        "val": (root / "val/val_images", root / "val/val.json"),
        "eval_debug": (root / "val/val_images", root / "val/val.json"),
        "test": (root / "val/val_images", root / "val/val.json"),  # Modify this if you have a test set
    }
...
if __name__ == "__main__":
    ...
    dataset_o365 = CocoDetection(
            '/content/drive/MyDrive/internship/train/train_images/',
            '/content/drive/MyDrive/internship/train/train.json',
            transforms=None,
            return_masks=False,
        )
